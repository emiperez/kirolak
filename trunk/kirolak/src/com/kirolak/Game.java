...
public class Game implements java.io.Serializable {
	...
	public Game(int id, Short roundId, Integer groupId, Integer homeTeamId,
			Integer visitingTeamId, Short homeTeamScore,
			Short visitingTeamScore, Byte gameStatus, Date scheduled) {
		this.id = id;
