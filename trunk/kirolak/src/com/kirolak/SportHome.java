...
public class SportHome {
	...
	public Sport merge(Sport detachedInstance) {
		...
		try {
			Sport result = (Sport) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Sport findById(short id) {
		log.debug("getting Sport instance with id: " + id);
		try {
			Sport instance = (Sport) sessionFactory.getCurrentSession().get(
					"com.kirolak.Sport", id);
			if (instance == null) {
	...
	public List<Sport> findByExample(Sport instance) {
		...
		try {
			List<Sport> results = (List<Sport>) sessionFactory
					.getCurrentSession().createCriteria("com.kirolak.Sport")
