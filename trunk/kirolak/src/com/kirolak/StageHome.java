...
/**
 * Home object for domain model class Stage.
 * @see com.kirolak.Stage
 * @author Hibernate Tools
 */
public class StageHome {

	private static final Log log = LogFactory.getLog(StageHome.class);
	...
	public void persist(Stage transientInstance) {
		log.debug("persisting Stage instance");
		try {
	...
	public Stage merge(Stage detachedInstance) {
		...
		try {
			Stage result = (Stage) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Stage findById(int id) {
		...
		try {
			Stage instance = (Stage) sessionFactory.getCurrentSession().get(
					"com.kirolak.Stage", id);
			if (instance == null) {
	...
	public List<Stage> findByExample(Stage instance) {
		...
		try {
			List<Stage> results = (List<Stage>) sessionFactory
					.getCurrentSession().createCriteria("com.kirolak.Stage")
