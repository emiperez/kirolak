...
public class GameHome {
	...
	public List<Game> findByExample(Game instance) {
		log.debug("finding Game instance by example");
		try {
			List<Game> results = (List<Game>) sessionFactory
					.getCurrentSession().createCriteria("com.kirolak.Game")
